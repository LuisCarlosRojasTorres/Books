...
Welcome back. In the last video, I taught you about VUCA. Can you remember what it stands for?
Play video starting at ::8 and follow transcript0:08
Volatility, uncertainty, complexity, and ambiguity. Great. In this video, we'll examine a project scenario with high VUCA parameters and how the Office Green team applied an Agile approach.
...
First, let's review some terms and concepts specific to Scrum. The Backlog is the central artifact in Scrum, where all possible ideas, deliverables, features, or tasks are captured for the team to work on. It's prioritized and proactively managed by the team continuously throughout the life of the project.
...
And then there's a practice called the Daily Scrum, also called the Stand-up. This is where the team meets for 15 minutes or less every day of the Sprint to inspect their progress toward their goal.
