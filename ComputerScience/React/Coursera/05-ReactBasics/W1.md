...
###  2.11. <a name='Lab:Creatingandimportingcomponents'></a>Lab: Creating and importing components

###  2.12. <a name='ReadingSolution:Creatingandimportingcomponents'></a>ReadingSolution: Creating and importing components

###  2.13. <a name='Selfreview:Creatingandimportingcomponents'></a>Self review: Creating and importing components

###  2.14. <a name='Knowledgecheck:Reactcomponentsandwheretheylive'></a>Knowledge check: React components and where they live
