...
- In this video, you will learn about the basics of React by exploring the concepts of:
  ...
  -  components:
     ...
     -  Independendt: Components can exist within tha same space independently from each other. 
     -  One of the advantages of developing using components is that many developers can work on the same project without interfering with the code of other developers' components.
  -  the virtual DOM: 
