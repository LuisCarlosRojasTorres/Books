...
If you have an object that is used across multiple threads, but most of the code is **reading** data from the objects.
6##  5. <a name='Schedulingandcancelingwork'></a>Scheduling and canceling work
